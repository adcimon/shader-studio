...
const css = `<link type="text/css" rel="stylesheet" href="./src/component/codeEditor/style.css">`;
...
export class CodeEditor extends HTMLElement
{
    ...
    connectedCallback()
    {
        ...
        this.flask = new CodeFlask(container, { language: 'js', lineNumbers: true, styleParent: this.shadowRoot });
